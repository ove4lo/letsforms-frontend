  ...
  return (
    <div className="min-h-screen w-full bg-background flex flex-col items-center justify-center gap-8 p-4">
          ...
          <div className="relative">
            ...
            <div className="w-20 h-20 bg-blue-100 dark:bg-blue-950 rounded-full flex items-center justify-center shadow-sm relative z-10">
              <div className="flex gap-5">
                <div className="w-3 h-5 bg-foreground rounded-full animate-blink" />
                <div className="w-3 h-5 bg-foreground rounded-full animate-blink animation-delay-300" />
              </div>
      ...
      <div className="text-center space-y-2">
        <p className="text-2xl font-semibold text-foreground animate-pulse">{message}</p>
