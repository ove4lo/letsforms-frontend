...
export function TextareaFieldProperties({ elementInstance, updateElement }: Props) {
    ...
    <div className="space-y-8">
      <div>
        ...
        <Input
          ...
          placeholder="Например: Опишите вас в 5 предложениях"
          className="mt-2"
        />
      </div>
      ...
      <div>
        ...
        <Input
          ...
          placeholder="Например: Ответственный, аккуратный, люблю горы"
          className="mt-2"
        />
      </div>
